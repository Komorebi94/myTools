<template>
	<section class="records-tab">
		...
		<p v-if="monthlySummary.planned === 0" class="summary-empty">
			本月暂无已过的训练日，或计划尚未开始
		</p>
			...
			<div class="calendar-toolbar">
				...
				>
					<svg viewBox="0 0 24 24" width="18" height="18" aria-hidden="true">
						<path
							fill="currentColor"
							d="M14.5 6.5 9 12l5.5 5.5-1.4 1.4L6.2 12l7-7.4 1.3 1.4Z"
						/>
					</svg>
				</button>
				...
				>
					<svg viewBox="0 0 24 24" width="18" height="18" aria-hidden="true">
						<path
							fill="currentColor"
							d="m9.5 6.5 5.5 5.5-5.5 5.5 1.4 1.4L17.8 12l-7-7.4-1.3 1.4Z"
						/>
					</svg>
				</button>
			</div>
			...
			<div class="calendar-grid">
				<button
					...
					:class="{
						...
						training:
							cell.isTrainingDay && cell.inMonth && !cell.isChecked && !cell.isMissed,
		...
		<section class="backup-panel">
			...
			<div class="backup-actions">
				<button type="button" class="backup-btn" @click="$emit('export-data')">
					导出备份
				</button>
