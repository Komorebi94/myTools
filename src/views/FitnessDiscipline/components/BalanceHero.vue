				...
				<div class="hero-stat-row">
					<div class="hero-stat">
						...
						<span class="hero-stat-val"
							>¥{{ formatMoney(simEarnings.cumulativeTotal) }}</span
						>
					...
					<div class="hero-stat accent">
						...
						<span class="hero-stat-val"
							>¥{{ formatMoney(simEarnings.afterTodayTotal) }}</span
						>
						<span class="hero-stat-hint"
							>含今日 +{{ formatMoney(simEarnings.todayAmount) }}</span
						>
					</div>
				</div>
				...
				<div v-if="simEarnings.cumulativeBreakdown" class="hero-detail-block">
					...
					<ul class="hero-breakdown-grid">
						<li>
							...
							<strong
								>¥{{
									formatMoney(simEarnings.cumulativeBreakdown.dailyBase)
								}}</strong
							>
						</li>
						<li>
							...
							<strong
								>¥{{
									formatMoney(simEarnings.cumulativeBreakdown.stepMeso)
								}}</strong
							>
						</li>
						<li>
						...
						<li>
							<span>动作进阶</span>
							<strong
								>¥{{ formatMoney(simEarnings.cumulativeBreakdown.variant) }}</strong
							>
						</li>
						<li class="wide">
							<span>放松周</span>
							<strong
								>¥{{ formatMoney(simEarnings.cumulativeBreakdown.deload) }}</strong
							>
						</li>
					</ul>
				</div>
			...
			<template v-else>
				<div v-if="canComplete" class="hero-stat-row single">
					<div class="hero-stat accent">
						...
						<span class="hero-stat-val"
							>+¥{{ formatMoney(liveEarnings.todayAmount) }}</span
						>
						<span class="hero-stat-hint">
